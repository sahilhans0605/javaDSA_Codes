...
//        1.f(n)= an^2+bn^2+c----->Worst case time complexity = n^4
//        2.f(n)= (an/4)+bn----->Worst case time complexity = n
//        3.f(n)= 100----->Worst case time complexity = 1
...
//        upar waala (bahr waala loop pure array pe iterate krega)...lekin andar waala swap krke elements ko break kr jaayega
//  Worst case....O(n^2)
